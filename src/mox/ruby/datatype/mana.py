...
# from .const import (
#     binary_ufunc_symbol_mapping,
#     reversed_symbol,
#     symbol_list_by_priority,
#     symbol_priority_mapping,
# )
...
#         ndarray_inputs = [
#             i.view(np.ndarray) if isinstance(i, np.ndarray) else i for i in inputs
#         ]
...
#             )
#         inputs_expr = tuple(
#             inpt.expr if hasattr(inpt, "expr") else str(inpt) for inpt in inputs
#         )
...
#             bracket(inputs[0])
#             if find_freesymbol(
#                 inputs[0], sum(symbol_list_by_priority[:symbol_priority], start=())
#             )
#             else inputs[0]
#         )
#         + f" {symbol} "
...
#                 sum(
#                     symbol_list_by_priority[
#                         : symbol_priority + int(symbol_priority in reversed_symbol)
#                     ],
#                     start=(),
#                 ),
#             )
